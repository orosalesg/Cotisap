-- --------------------------------------------------------
-- Host:                         cotisap.com
-- Versión del servidor:         5.5.58-cll - MySQL Community Server (GPL)
...
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_articulos
CREATE TABLE IF NOT EXISTS `alianzaelectrica_articulos` (
...
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_art_quotations
CREATE TABLE IF NOT EXISTS `alianzaelectrica_art_quotations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_capacitacions
CREATE TABLE IF NOT EXISTS `alianzaelectrica_capacitacions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_companies
CREATE TABLE IF NOT EXISTS `alianzaelectrica_companies` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `status` tinyint(1) NOT NULL,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_notes
CREATE TABLE IF NOT EXISTS `alianzaelectrica_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_payment
CREATE TABLE IF NOT EXISTS `alianzaelectrica_payment` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `numCotizacion` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_policies
CREATE TABLE IF NOT EXISTS `alianzaelectrica_policies` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_quotations
CREATE TABLE IF NOT EXISTS `alianzaelectrica_quotations` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_roles
CREATE TABLE IF NOT EXISTS `alianzaelectrica_roles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_sliders
CREATE TABLE IF NOT EXISTS `alianzaelectrica_sliders` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `titulo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `archivo` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_specs
CREATE TABLE IF NOT EXISTS `alianzaelectrica_specs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_template
CREATE TABLE IF NOT EXISTS `alianzaelectrica_template` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- La exportación de datos fue deseleccionada.
-- Volcando estructura para tabla cotisap_01.alianzaelectrica_tools
CREATE TABLE IF NOT EXISTS `alianzaelectrica_tools` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
