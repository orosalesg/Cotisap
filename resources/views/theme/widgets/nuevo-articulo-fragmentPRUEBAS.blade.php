          ...
          <div class="an-component-body">
            <div class="an-helper-block">
              ...
              <div class="an-input-group">
                ...
                <input type="text" id="descArt" class="an-form-control not-nul0l" name="descArt" placeholder="{{'Escriba una breve descripción del artículo'}}" maxlength="254">
              ...
              <div class="an-input-group">
                <div class="an-input-group-addon"><i class="ion-information-circled"></i></div>
                <input type="text" id="marca" class="an-form-control not-nul0l" name="marca" placeholder="{{'Escriba la marca del articulo'}}" maxlength="50">
              ...
              <div class="an-input-group">
                ...
                <textarea class="an-form-control" id="comm" placeholder="Escribe un comentario..." maxlength="255"></textarea>
              </div>
