            ...
            <div class="an-component-body">
                <div class="an-helper-block">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="an-input-group">
                                ...
                                <input type="text" id="rfcCliente" class="an-form-control not-null"
                                    name="rfcCliente" placeholder="{{'Introduzca el rfc del cliente'}}"
                                    maxlength="60" />
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row" style="padding-left:20px;padding-right:20px;">
                        <p class="an-small-doc-blcok" style="font-size:16px;" id="update-instr">Informacion de entrega.(opcional)</p>
                        <div class="col-md-12"><span>*Dejando en blanco los campos, se utilizará la información de arriba</span></div><br>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="an-input-group">
                                ...
                                <input type="text" id="personaContacto" class="an-form-control"
                                    name="personaContacto" placeholder="{{'Persona de contacto'}}"
                                    maxlength="60" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="an-input-group">
                                <div class="an-input-group-addon"><i class=""></i></div>
                                <input type="text" id="domicilioEntrega" class="an-form-control"
                                    name="domicilioEntrega" placeholder="{{'Direccion de entrega'}}"
                                    maxlength="60" />
                            </div>
                        </div>
                    </div>
    ...
    <div id="product-base">
        <div id="item-product[Element]" class="item-product row">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="an-input-group">
                        <input type="text" name="itemNoserie[Element]" id="itemNoserie[Element]" class="itemNoserie an-form-control">
                        <!--<input type="text" id="itemName[Element]" name="itemName[Element]" class="itemName an-form-control" maxlength="255">-->
                    </div>
                </div>
