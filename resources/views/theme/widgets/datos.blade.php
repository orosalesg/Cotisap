            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-6">
                <div class="an-panel-main-info-single pale-yellow with-shadow wow fadeIn" data-wow-delay=".3s">
                  <h2><span style="display:none;font-size:15px;" id="last_quotation"></span><div class="text-center" id="lq_loader"><img src="{{asset('assets/img/loading.gif')}}" width="40" height="33"/></div><span class="info-identifier">{{ 'Ultima cotización' }}</span></h2>
