...
<table id="detalle">
	...
	<tbody>
        ...
        <tr>
            ...
            <td colspan="3" style="text-align: right!important;padding-bottom:2em;">
                {{ 'Sub Total hasta comentario' }}
            </td>
            <td style="padding-bottom:2em;">
               $ {{ $a['subTotalLinea'] }} 
            </td>
...
<!--<br><img style="width: 100%;
    ...
    display: block;
    margin-top: 40px;
    margin-left: -20px;" src="http://account.cotisap.com/assets/img/bannercoti.jpg">
<br>--->
    
<div id='promocion' style="display:{{ $data['display'] }};">
    <h3>{{ $data['NoImagen'] }}</h3>
    <img style="width: 100%;height: 150px;padding: 10px 20px;box-sizing: border-box;display: block;" src="assets/img/bannerscotizacion/{{ $data['NoImagen'] }}.png"></img>
</div>
    <script>
    /*$(document).ready(function(){
        console.log("dentro de funcion");
        var elemento=document.getElementById("promocion");
        var cantidadImágenes=4;
        var aleatorio=Math.floor(Math.random()*cantidadImágenes);
        elemento.html("Imagen es igual a <img style='width: 100%;height: 150px;padding: 10px 20px;box-sizing: border-box;display: block;' src='assets/img/bannerscotizacion/"+aleatorio+".png"'></img>");
    });*/
    </script>
</body>
</html>