...
@section('custom-styles')
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/step-progressbar.css') }}">
        ...
        <div class="an-content-body home-body-content">
          <div class="an-breadcrumb wow fadeInUp">
            <ol class="breadcrumb">
              ...
              <li class="active">Monitor de avance</li>
            </ol>
          </div> <!-- end AN-BREADCRUMB -->

          <div class="an-body-topbar wow fadeIn">
            <div class="an-page-title">
              <h2>Monitor de avance</h2>
            </div>
          </div> <!-- end AN-BODY-TOPBAR -->
          @include('theme.widgets.monitor-avance')
...
@section('scripts')
  ...
  <script type="text/javascript">
    ...
    var facturas = "{{ URL::route('buscar-facturas') }}";
    var entregas = "{{ URL::route('buscar-entrega') }}";
    var getProgress = "{{ URL::route('getProgress') }}";
  </script>
  <script src="{{ asset('assets/js/monitor.js') }}" type="text/javascript"></script>
