  ...
  */
  ...
  if ($('#reportrange').length > 0) {
    ...
    function cb(start, end) {
      ...
      $('#reportrange span.hidden').html(start.format('YYYY-MM-DD') + '&' + end.format('YYYY-MM-DD'));
    }
  ...
  if ($('#calendario').length > 0) {
    ...
    function cb(start, end) {
      //start.localeData("es");
      $('#calendario span').html(start.format('MMM D, YYYY') + ' - ' + end.format('MMM D, YYYY'));
      $('#calendario span.hidden').html(start.format('YYYY-MM-DD') + '&' + end.format('YYYY-MM-DD'));
    }
