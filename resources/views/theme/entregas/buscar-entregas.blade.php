        ...
        <div class="an-content-body home-body-content">
          ...
          <div class="an-breadcrumb wow fadeInUp">
            <ol class="breadcrumb">
              ...
              <li class="active">{{ 'Buscar entregas' }}</li>
            </ol>
          </div>
         ...
         @include('theme.widgets.buscar-entregas-fragment')
...
@section('scripts')
  ...
  <script type="text/javascript">
    ...
    var getslp = "{{ URL::route('getAllSLP') }}";
  </script>
  <script src="{{ asset('assets/js/sweetalert.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/js/entregas/entregas.js') }}" type="text/javascript"></script>
