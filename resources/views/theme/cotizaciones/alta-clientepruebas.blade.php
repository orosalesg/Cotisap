    ...
    <div class="main-wrapper">
      ...
      <div class="an-page-content">
        ...
        <div class="an-content-body home-body-content">
          ...
          @include('theme.widgets.alta-cliente-fragmentpruebas')
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#updateCliente").click(function(){
            ...
            Swal.fire({
                title: '¿Realmente quieres editar este cliente?',
                showDenyButton: true,
        ...
        $(".delete").click(function(){
            ...
            Swal.fire({
              title: '¿Realmente quieres borrar este cliente?',
              showDenyButton: true,
              showCancelButton: false,
              confirmButtonText: 'Borrar Clietne',
              denyButtonText: `Cancelar`,
            }).then((result) => {
