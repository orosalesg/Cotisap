                ...
                <div class="col-md-4">
                    <div class="an-input-group">
                        ...
                        <div class="col-md-6" style="display: inline-block">
                            ...
                            <div>
                                <button class="btn" data-toggle="formatores"><i class="gg-info"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Especificaciones y total cotizacion -->
<div class="row mb-3">
    <div class="col-md-6">
...
<!-- Notas comerciales y cuentas de pago -->
<div class="row mb-3">
...
<!-- Informacion de entrega y comentarios generales -->
<div class="row mb-3">
...
<div class="d-none">
    ...
    <div id="product-base">
        ...
        <div id="item-product[Element]" class="item-product row draggable" style="position:relative;z-index:100;padding-top:30px;">
...
$(document).ready(function() {
    ...
    const mouseDownHandler = function(e) {
        ...
        //console.log(e);
        //si el div seleccionado no es el contenedor padre regresa
        if(!String(draggingEle.id).includes("item-product") ){
            return;
        }
    ...
    const mouseMoveHandler = function(e) {
        ...
        if (prevEle && isAbove(draggingEle, prevEle)) {
            ...
            var draggingEleId = $("#" + draggingEle.id).find(".item-id");
            var prevEleId = $("#" + prevEle.id).find(".item-id");
            console.log("dragging id: ");
            console.log(draggingEleId);
            console.log("prev id: ");
            console.log(prevEleId);
        ...
        if (nextEle && isAbove(nextEle, draggingEle)) {
            ...
            // nextEle              -> draggingEle
            var draggingEleId = $("#" + draggingEle.id).find(".item-id");
            var nextEleId = $("#" + nextEle.id).find(".item-id");

            console.log("dragging id: ");
            console.log(draggingEleId);
            console.log("nextEle id: ");
            console.log(nextEleId);
    ...
    function initialize_mousedown() {
        const list = document.getElementById('contenerdor-products');
        // Query all items
    ...
    $('[data-toggle="formatores"]').popover({

        html: true,
        container: 'body',
        trigger: 'focus',
        title: 'Formato: ' /*+ $("#formatoCoti option:selected").text()*/ ,
        content: $('#demoformato').html()

    });

    $("#formatoCoti").on('change', function() {
        $("#imgformatoscoti").attr('src', '{{ asset("assets/img/formatoscoti/coti_") }}' + $(
            "#formatoCoti").val() + ".png")
    });
