    ...
    <div class="an-single-component with-shadow">
          <div class="an-component-header">
            ...
            <div class="component-header-right">
              ...
              <div class="btn-space">
                    <button style="display: none;" id="create-btn" class="an-btn an-btn-success block-icon" data-toggle="modal" data-target="#addCap"> <i class="ion-plus-round"></i>Agregar</button>
                    <button id="update-btn-trigger" class="an-btn an-btn-success block-icon" data-toggle="modal" data-target="#addCap" style="display: none;"> <i class="ion-plus-round"></i>Agregar</button>
              </div>
            </div>
          </div>
          <div class="an-component-body padding20">
            ...
            <div style='padding: 20px;' >
              <table id="cap-table" hidden="hidden" width="100%" class="display" cellspacing="0">
                <thead>
      ...
      <div class="modal fade primary" id="addCap" tabindex="-1" role="dialog" aria-labelledby="addNotas">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div id="row-id">
                  <label for="titCap">ID: </label>
                  <div class="row" id="row-cap">
                    <div class="col-md-4">
                      <div class="an-input-group">
                        <div class="an-input-group-addon"><i class="ion-pound"></i></div>
                        <input id="idCap" type="text" class="an-form-control text-center" placeholder="ID" data-toggle="tooltip" title="Hello" value="" disabled="disabled" />
                      </div>
                    </div>
                  </div>
                </div>
                <label for="titCap">Título de la capacitación: </label>
                <div class="an-input-group">
                  <div class="an-input-group-addon" id="titCapIcon"><i class=""></i></div>
                  <input id="titCap" type="text" class="an-form-control" placeholder="Título" data-toggle="tooltip" title="Hello" />
                </div>
                <div id="row-cat-info">
                <label for="descCap">Categoría: </label>
                  <div class="an-input-group">
                    <div class="an-input-group-addon" id=""><i class=""></i></div>
                    <input id="catCap" type="text" class="an-form-control" placeholder="" disabled="disabled" />
                  </div>
                </div>

                <label for="descCap">Descripción: </label>
                <div class="an-input-group">
                  <textarea id="descCap" placeholder="Escribe una breve descripción" data-toggle="tooltip" title="Hello" cols="75" rows="2"></textarea>
                </div>
                ...
                <div class="text-center" id="row-link" hidden="hidden">
                  <div class="an-input-group">
                    <div class="an-input-group-addon" id="linkCapIcon"><i class=""></i></div>
                    <input id="linkCap" type="text" class="an-form-control" placeholder="Link" data-toggle="tooltip" title="Hello" />
                  </div>
                </div>
