            ...
            <div class="row">  
              ...
              <div class="col-md-7">
                <div class="row">
                  <div class="col-md-2">
                    <div class="an-input-group">
                      <input type="text" id="itemPlista[Element]" name="itemPlista[Element]" class="itemPlista an-form-control dinero" maxlength="255">
                    </div>
                  </div>
                  <div class="col-md-1">
                    <div class="an-input-group">
                  ...
                  <div class="col-md-2">
                    <div class="an-input-group">
                      <input type="number" id="itemCantidad[Element]" name="itemCantidad[Element]" class="itemCantidad an-form-control" value="1">
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="an-input-group">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="an-input-group">
                      <input type="text" id="itemEntrega[Element]" name="itemEntrega[Element]" class="itemEntrega an-form-control" maxlength="255">
                    </div>                     
                  </div>
                  <div class="col-md-4">
                    <div class="an-input-group">
              ...
              <div class="col-md-7">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="an-input-group">
                      <input type="number" id="itemDesc[Element]" name="itemDesc[Element]" class="itemDesc an-form-control" maxlength="255">
                    </div>                    
                  </div>
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="an-input-group">
                      <input type="text" id="itemComentario[Element]" name="itemComentario[Element]" class="itemComentario an-form-control" maxlength="255">
                    </div>                     
                  </div>
                </div>
              </div>
    ...
    *********************/
      ...
      $('#itemCodigo\\[' + producIni + '\\]').on('select2:select', function (e) {
        ...
        $.ajax({
          ...
          success: function (result) {
            ...
            $('#itemPlista\\[' + producIni + '\\]' ).val(result[0].Price == ".00" ? result[0].LastPurPrc : result[0].Price);
            ...
            if(result[0].LastPurPrc == null || result[0].LastPurPrc == ""){
                $('#itemCosto\\[' + productItem + '\\]' ).text( result[0].Price + ' ' + result[0].LastPurCur );
            }
            
            $('#itemMarca\\[' + productItem + '\\]' ).html(result[0].FirmName);

            // $monedas[1]->ISOCurrCod = {{$monedas[1]->ISOCurrCod}} / $monedas[0]->ISOCurrCod = {{$monedas[0]->ISOCurrCod}}
            if(result[0].LastPurCur == "{{$monedas[1]->ISOCurrCod}}" && modenaLabel == "{{$monedas[0]->ISOCurrCod}}" ){
                calculoProdLoadUSDtoMXN(productItem);
            }else if( (result[0].LastPurCur == "{{$monedas[0]->ISOCurrCod}}" || result[0].LastPurCur == "MXP") && modenaLabel == "{{$monedas[1]->ISOCurrCod}}"){
    ...
    function calculoTipoCambioMG(prod){
        ...
        if(monedaLabel == "{{ $monedas[0]->ISOCurrCod }}"){
            $('#itemPlista\\[' + productItem +'\\]').val( Number($('#itemPlista\\[' + productItem +'\\]').val() * Number(tc) ).toFixed(2) );
        }else{
            $('#itemPlista\\[' + productItem +'\\]').val( Number($('#itemPlista\\[' + productItem +'\\]').val() / Number(tc) ).toFixed(2) );
        }
    }
