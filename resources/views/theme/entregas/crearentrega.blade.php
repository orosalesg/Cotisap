        ...
        <div class="an-content-body home-body-content">
            ...
            <div class="an-breadcrumb wow fadeInUp">
                <ol class="breadcrumb">
                    ...
                    <li class="active">{{ 'Crear Hoja de Entrega' }}</li>
                </ol>
            </div>

            <div class="an-body-topbar wow fadeIn">
                <div class="an-page-title">
                    <h2>{{ 'Crear Hoja de Entrega' }}</h2>
                </div>
            </div>


            @include('theme.widgets.showcrearentregas')
...
<script>
    ...
    function validarDatosCliente() {
        ...
        if ($("#telCliente").val() == null || $("#domicilioCliente").val() == "") {
