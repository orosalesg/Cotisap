                        ...
                        <ul class="nav nav-tabs text-center" role="tablist">
                          <li role="presentation" class="active">
                              <a href="#general" aria-controls="diska" role="tab" data-toggle="tab" aria-expanded="true">
                                  <i class="ion-ios-person-outline"></i>Información general</a>
                          </li>
                      ...
                      <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="seguridad">
                        	...
                        	<div class="row">
	                          	<div class="col-md-6">
									...
									<div class="an-input-group">
										...
										<input type="text" id="pass" class="an-form-control" placeholder="Nueva contraseña">
									</div>
	                          	</div>
	                          	<div class="col-md-6">
									...
									<div class="an-input-group">
										<div class="an-input-group-addon"><i class=""></i></div>
										<input type="text" id="passconf" class="an-form-control" placeholder="Repita nueva contraseña">
									</div>                          		
	                          	</div>
                        	</div>
                        	...
                        	<div class="row">
                        	    ...
                        	    <div class="col-md-3">
                        	        <input type="submit" id="newPass" class="btn an-btn-primary" name="success" value="Cambiar Contraseña">
